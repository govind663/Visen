...
class StatisticsController extends Controller
{
    ...
    public function store(StatisticsRequest $request)
    {
        ...
        try {
            ...
            return redirect()->route('statistics.index')->with('message', 'statistics has been successfully added.');
    ...
    public function update(StatisticsRequest $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->route('statistics.index')->with('message', 'statistics has been successfully updated.');
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return redirect()->route('statistics.index')->with('message', 'statistics has been successfully deleted.');
