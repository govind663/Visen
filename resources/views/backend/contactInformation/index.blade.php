...
@section('title')
Visen | Manaage Contact Information
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('contact-information.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i> Contact Information
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All Contact Information List</h4>
            </div>
            <div class="pb-20">
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-export">
                                <a href="{{ route('contact-information.edit', $value->id) }}">
                            ...
                            <td class="no-export">
                                <form action="{{ route('contact-information.destroy', $value->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
    ...
    $('.data-table-export1').DataTable({
        ...
        buttons: [
            ...
            },
            {
               ...
               header: true,
               title: 'All Contact Information List',
