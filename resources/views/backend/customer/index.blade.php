...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('customer.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i> Customer
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All Customer List</h4>
            </div>
            <div class="pb-20">
                <table class="table hover multiple-select-row data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($value->image)
                                    <img src="{{ asset('/visen/customer/image/' . $value->image) }}" alt="Industry Image" style="width: 35%; height: 15%;">
                                @endif
                            </td>
