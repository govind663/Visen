...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('customer.update', $customer->id) }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg" name="image" id="image" class="form-control @error('image') is-invalid @enderror" value="{{ $customer->image }}" placeholder="Upload Image.">
                        ...
                        @if (!empty($customer->image))
                            <img src="{{ asset('/visen/customer/image/' . $customer->image) }}" alt="Customer Image" style="width: 100%; height: 50%;">
                        @endif
                    </div>
                </div>
