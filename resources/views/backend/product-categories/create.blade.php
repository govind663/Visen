...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('product-category.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pd-20 card-box mb-30">
                        ...
                        <select name="product_id" id="product_id" class="custom-select2 form-control @error('product_id') is-invalid @enderror" style="width: 350px !important;">
                            ...
                            <optgroup label="Product Name">
                                @foreach($products as $value)
                                    <option value="{{ $value->id }}" {{ old('product_id') == $value->id ? 'selected' : '' }}>{{ $value->productName }}</option>
                                @endforeach
                            </optgroup>
                        </select>
                        @error('product_id')
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Sub Product Name" value="{{ old('name') }}">
                        @error('name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="solidContentInPercentage" id="solidContentInPercentage" class="form-control @error('solidContentInPercentage') is-invalid @enderror" placeholder="Enter Solid Content %" value="{{ old('solidContentInPercentage') }}">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="viscosity" id="viscosity" class="form-control @error('viscosity') is-invalid @enderror" value="{{ old('viscosity') }}" placeholder="Enter Viscosity.">
                        @error('viscosity')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="mfet" id="mfet" class="form-control @error('mfet') is-invalid @enderror" value="{{ old('mfet') }}" placeholder="Enter MEFT.">
                        @error('mfet')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-9 col-md-9 mb-4">
                        <textarea name="description" id="description" class="textarea_editor form-control border-radius-0 @error('description') is-invalid @enderror" placeholder="Enter Features / Recommended Application" value="{{ old('description') }}">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-sm-9 col-md-9">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg, .pdf" name="resource_doc" id="resource_doc" class="form-control @error('resource_doc') is-invalid @enderror" value="{{ old('resource_doc') }}" placeholder="Upload Resources Document.">
