...
@section('title')
Visen | Manaages Product Category
@endsection
...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('product-category.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i> Product Category
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All Product Category List</h4>
            </div>
            <div class="pb-20">
                <table class="table hover  data-table-export1 nowrap p-3">
                    <thead>
                        <tr>
                            ...
                            <th>Viscosity</th>
                            <th>MFET</th>
                            <th>Features / Recommended Application</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">
                                {{ $value->solidContentInPercentage }}
                            </td>
                            ...
                            <td class="no-export">
                                <a href="{{ route('product-category.edit', $value->id) }}">
    ...
    $('.data-table-export1').DataTable({
        ...
        buttons: [
            ...
            },
            {
               ...
               header: true,
               title: 'All Product Category List',
