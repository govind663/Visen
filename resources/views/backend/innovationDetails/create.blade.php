...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('innovation-details.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg" name="banner_image" id="banner_image" class="form-control @error('banner_image') is-invalid @enderror" value="{{old('banner_image')}}" placeholder="Upload Banner Image.">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="bannerVideoPreviewFile()" accept=".mp4" name="banner_video" id="banner_video" class="form-control @error('banner_video') is-invalid @enderror" value="{{old('banner_video')}}" placeholder="Upload Banner Video.">
