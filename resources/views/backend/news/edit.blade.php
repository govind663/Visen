...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <form method="POST" action="{{ route('news.update', $news->id) }}" class="form-horizontal" enctype="multipart/form-data">
            ...
            <input type="text" id="id" name="id" hidden  value="{{ $news->id }}">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ $news->title }}" placeholder="Enter Title.">
                        @error('title')
                    ...
                    <div class="col-sm-4 col-md-4">
                        <input type="file" onchange="agentPreviewFile()" accept=".png, .jpg, .jpeg" name="image" id="image" class="form-control @error('image') is-invalid @enderror" value="{{ $news->image }}" placeholder="Upload Image.">
                        ...
                        <br>
                        @if (!empty($news->image))
                            <img src="{{ asset('/visen/news/image/' . $news->image) }}" alt="news Image" style="width: 100%; height: 50%;">
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-10 col-md-10">
                        <textarea name="description" id="description" class="textarea_editor form-control border-radius-0 @error('description') is-invalid @enderror" placeholder="Enter Description" value="{{ $news->description }}">{{ $news->description }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
