...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <div class="dropdown">
                        <a class="btn btn-primary" href="{{ route('news.create') }}">
                            <i class="fa fa-plus" aria-hidden="true"> </i> News
                        </a>
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All News List</h4>
            </div>
            <div class="pb-20">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">
                                @if($value->image)
                                    <img src="{{ asset('/visen/news/image/' . $value->image) }}" alt="{{ $value->image }}" style="width: 100px; height: auto;">
                                @endif
                            </td>
