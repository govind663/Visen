                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-4 col-md-4">
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <img src="{{ asset('bhairaav/banner/banner_image/' . $banner->banner_image) }}" alt="Banner Image" style="width: 100px; height: auto;">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-md-4">
                        ...
                        <div class="col-sm-6 col-md-6">
                            ...
                            <video controls style="width: 100%; height: auto;">
                                <source src="{{ asset('bhairaav/banner/banner_video/' . $banner->banner_video) }}" type="video/mp4">
