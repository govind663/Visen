                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">
                                @if($slider->banner_image)
                                    <img src="{{ asset('bhairaav/banner/banner_image/' . $slider->banner_image) }}" alt="Banner Image" style="width: 100px; height: auto;">
                                @elseif($slider->banner_video)
                                    <video width="300" height="auto" controls>
                                        <source src="{{ asset('bhairaav/banner/banner_video/' . $slider->banner_video) }}" type="video/mp4">
