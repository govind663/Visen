...
<div class="pd-ltr-20 xs-pd-20-10">
    <div class="min-height-200px">
        ...
        <div class="card-box mb-30">
            <div class="pd-20">
                <h4 class="text-blue h4">All Members List</h4>
            </div>
            <div class="pb-20">
                <table class="table hover data-table-export1 nowrap p-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-wrap text-justify">{{ $value->teamName?->title }}</td>

                            <td class="text-wrap text-justify">
                                @if($value->memberProfilePic)
                                    <img src="{{ asset('/visen/members/memberProfilePic/' . $value->memberProfilePic) }}" alt="{{ $value->memberProfilePic }}" style="width: 100px; height: auto;">
                                @endif
                            </td>

                            <td class="text-wrap text-justify">{{ $value->memberName }}</td>

                            <td class="text-wrap text-justify">{{ $value->memberPosition }}</td>

                            <td class="text-nowrap text-justify">{!! $value->memberDescription !!}</td>
